...
class RidePrefService {
  ...
  static List<RidePref> getTodayRidePrefs() {
    DateTime today = DateTime.now();
    return ridePrefsHistory.where((ridePref) {
      return ridePref.departureDate.year == today.year &&
          ridePref.departureDate.month == today.month &&
          ridePref.departureDate.day == today.day;
    }).toList();
  }
}
